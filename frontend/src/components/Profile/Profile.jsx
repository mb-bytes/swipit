...
export function Profile() {
  ...
  return (
    <div className="flex flex-1 h-full min-h-0 min-w-0 overflow-hidden">
      <div className="flex h-full w-full flex-1 flex-col gap-5 md:gap-6 rounded-tl-2xl border-l border-t border-neutral-300/80 bg-[#f8f9fb] p-5 md:p-6 lg:p-7 paper-grain overflow-y-auto min-h-0">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 pb-2 border-b border-neutral-200/80 shrink-0">
          <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-stretch">
          ...
          <div className="lg:col-span-5 flex flex-col">
            <motion.div
              ...
              className="relative overflow-hidden rounded-2xl bg-[#111215] text-[#f2eee5] border border-neutral-800 shadow-xl p-5 sm:p-6 flex flex-col justify-between h-full group"
            >
              ...
              <div className="relative z-10 py-3 my-auto flex flex-col gap-2">
                ...
                <div className="font-mono text-sm tracking-wider text-neutral-300 pt-0.5">
                  {username}
                </div>
          ...
          <div className="lg:col-span-7 flex flex-col">
            <div className="rounded-2xl border border-neutral-200/90 bg-white p-5 sm:p-6 shadow-xs flex flex-col justify-between h-full gap-3.5">
              ...
              <div className="flex items-center justify-between pt-2.5 border-t border-neutral-100">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl text-xs font-semibold bg-[#111215] text-[#f2eee5] hover:bg-neutral-800 transition-colors cursor-pointer shadow-xs shrink-0"
                >
                  <span>
                    {googleStatus.connected
