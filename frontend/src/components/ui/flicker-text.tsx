...
function __OriginkitBase_OutlineFillText(props: any) {
...
export default function OutlineFillText(props: Record<string, unknown>) {
  const mergedFont = props.font !== undefined ? props.font : (props.className ? undefined : __originkitPresetProps.font);
  return <__OriginkitBase_OutlineFillText {...__originkitPresetProps} {...props} font={mergedFont} />;
}

export { OutlineFillText, OutlineFillText as FlickerText };