...
const SURFACE = "bg-black border border-neutral-800/80 shadow-md";
const RECESS = "bg-[#141414] border-l border-neutral-800/80";
const GLYPH = "text-[#868593] dark:text-[#9B9AA7]";
const FOCUS = "outline-none focus-visible:ring-2 focus-visible:ring-[#868593]";
const ACCENT = "#FF5F2E";

const LIFT =
  "shadow-[0_1px_4px_rgba(0,0,0,0.6),inset_0_0.5px_0_rgba(255,255,255,0.1)]";

const CIRCLE = `grid h-7 w-7 place-items-center rounded-full transition-colors duration-200 hover:bg-[#222222] ${FOCUS} bg-black ${LIFT}`;
