...
import { Sidebar, SidebarBody, SidebarLink, useSidebar } from "./sidebar-component";
import {
    IconArrowLeft,
    IconBrandTabler,
    IconSettings,
...
export function SidebarDemo({ children }) {
    ...
    const handleLogout = async () => {
        sileo.promise(
            logout(),
            {
                loading: { title: "Signing out...", description: "Clearing your session" },
                success: { title: "Signed out", description: "See you next time!" },
            ...
            >
                <div
                    className={cn(
                        ...
                        menuOpen ? "bg-amber-400 text-neutral-950" : "bg-[#111215] text-[#f2eee5]"
                    )}
                >
                ...
                <motion.span
                    ...
                    className={cn(
                        ...
                        menuOpen ? "text-[#f2eee5] font-semibold" : "text-neutral-800 font-medium"
                    )}
                >
                    {displayName}
                </motion.span>
                ...
                {sidebarOpen && (
                    <motion.span
                        ...
                        className={cn(
                            ...
                            menuOpen ? "text-neutral-400" : "text-neutral-400 group-hover:text-neutral-600"
                        )}
                    >
