          ...
          >
            <div className="flex items-center justify-between px-6 py-5 border-b border-white/10 shrink-0">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-full bg-[#121c18] border border-teal-800/40 text-teal-300 flex items-center justify-center shrink-0">
                  <HugeIcon icon={AlertCircleIcon} size={18} />
                </div>
                <div>
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  type="button"
                  onClick={onClose}
                  className="text-neutral-400 hover:text-white rounded-full p-1.5 hover:bg-white/10 transition-colors cursor-pointer"
                >
              ...
              {showAssignAll && items.length > 0 && (
                ...
                >
                  <div className="px-5 py-4 bg-amber-500/[0.07] border-b border-amber-500/20 flex flex-col gap-3">
                    ...
                    <div className="flex items-center gap-2">
                      <HugeIcon icon={CreditCardIcon} size={14} className="text-neutral-400 shrink-0" />
                      <Dropdown
                        className="flex-1"
                    ...
                    >
                      {isAssigningAll ? (
                        ...
                        <>
                          <HugeIcon icon={ArrowRightDoubleIcon} size={14} />
